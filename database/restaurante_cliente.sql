...
CREATE TABLE `cliente` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_cliente_morada` (`morada_id`),
  KEY `fk_cliente_utilizador` (`utilizador_id`),
  CONSTRAINT `fk_cliente_morada` FOREIGN KEY (`morada_id`) REFERENCES `morada` (`id`),
...
INSERT INTO `cliente` VALUES (1,3,123456789,'912412186',4),(2,4,123456789,'916854163',6);
