...
CREATE TABLE `ementa` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_ementa_restaurante` (`restaurante_id`),
  KEY `fk_ementa_tipo` (`tipo_id`),
  CONSTRAINT `fk_ementa_restaurante` FOREIGN KEY (`restaurante_id`) REFERENCES `restaurante` (`id`),
  CONSTRAINT `fk_ementa_tipo` FOREIGN KEY (`tipo_id`) REFERENCES `tipo` (`id`)
...
-- Dump completed on 2023-05-23  9:51:18
