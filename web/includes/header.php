    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="../paginasWeb/mudarCliente.php" class="nav-link px-2 text-white">Gerir Perfil</a></li>
          <div class="text-end">
          <button type="button" class="btn btn-outline-light me-2"><a style="color: white; text-decoration: none;" href="../paginasWeb/logOut.php">Logout</a></button>
        </ul>
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <div class="text-end">
          <button type="button" class="btn btn-outline-light me-2"><a style="color: white; text-decoration: none;" href="../paginasWeb/logOut.php">Log out</a></button>
        </div>
        </ul>
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="../paginasWeb/listaEmentas.php" class="nav-link px-2 text-white">Activar Pratos</a></li>
          <li><a href="../paginasWeb/mudarPratos.php" class="nav-link px-2 text-white">Alterar Pratos</a></li>
          <li><a href="../paginasWeb/relatorio.php" class="nav-link px-2 text-white">Relatorio</a></li>
        </ul>
        <div class="text-end">
          <button type="button" class="btn btn-outline-light me-2"><a style="color: white; text-decoration: none;" href="../paginasWeb/logOut.php">Log Out</a></button>
        </div>
